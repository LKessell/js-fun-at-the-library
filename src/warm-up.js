...
var sequel = `${title} 2: Electric Boogaloo`;
...
var books = ["Howl's Moving Castle", "Welcome to Night Vale", "Deadline", "Sibley Field Guide to Birds", "Mordenkainen's Tome of Foes"];
